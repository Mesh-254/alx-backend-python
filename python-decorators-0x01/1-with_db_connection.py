...
# with automatic database connection handling
...
def get_user_by_id(conn, user_id):
    ...
    This function executes a SQL SELECT query to find
    a user by their ID and returns the result.
    ...
    Returns:
        tuple: A tuple containing the user's data, or None if
