...
class DatabaseConnection:
    ...
    Automatically opens and closes connections to ensure safe resource management.
    """
    ...
    def __enter__(self):
        ...
        self.conn = pymysql.connect(
            ...
            password=os.getenv('DB_PASSWORD'),  # User's password
            database=os.getenv('DB_DATABASE'),  # Target database name
...
# Using the DatabaseConnection context manager to safely handle database interactions
